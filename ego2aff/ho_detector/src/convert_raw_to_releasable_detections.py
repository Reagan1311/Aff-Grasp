...
ho_path = '/home/gen/Ego4d/data/v2/clips_ho_detections/8ec40595-b96a-4b54-9046-a14f46e193af.pkl'
...
sys.path.insert(0, os.path.join(project_root, 'src/public_lib'))  # isort:skip
